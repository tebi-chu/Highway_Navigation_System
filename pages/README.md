...
地点データは上下線について照合し、一関IC～盛岡IC間で欠けていた一関IC、平泉スマートIC、中尊寺PA、水沢IC、花巻IC、紫波SA、紫波IC、矢巾PA・スマートIC、盛岡南IC、滝沢ICを補完しています。SA・PA併設スマートICなど、1か所に複数種別がある地点もそれぞれ表示します。
...
設備欄に表示するのは、食事、コンビニ、カフェ、ガソリンスタンド、温泉、シャワー、ビューエリアだけです。スターバックス、タリーズ、ドトール、セブンイレブン、ローソン、ファミリーマートはピクトグラムではなく文字バッジで表示します。
